...
urlpatterns = [
    ...
    path('preview-commodity/<int:id>/', views.preview_commodity, name = "preview_commodity"),
    ...
    path('commodity-verify/<int:comm_id>/', views.commodity_verify, name="commodity_verify"),
    path('search-commodity/', views.search_commodity, name = "search_commodity"),
    path('commodity-image/<int:id>/', views.commodity_image, name = "commodity_image"),
]
